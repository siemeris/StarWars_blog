...
export const PlanetCard = () => {
    ...
    return(
        ...
        <img src={"https://starwars-visualguide.com/assets/img/planets/" + value.uid + ".jpg"} className="card-img-top" style={{height: '14rem', width:"100%", objectFit:"cover"}} alt="Planet Image"></img>
